        ...
        <div class="col-md-3">
          ...
          <div class="card card-primary">
            ...
            <div class="card-body">
              ...
              <p class="text-muted">
                <p class="text-muted"><a href="{{ asset("storage/".$user->profileable->cnic_front) }}">Front</a></p>
                <p class="text-muted"><a href="{{ asset("storage/".$user->profileable->cnic_back) }}">Back</a></p>
