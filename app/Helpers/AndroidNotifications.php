...
class AndroidNotifications {
    static public function to($title, $messag, $token,Array $data)
    {
    ...
    static public function Multiple($tokenList, $messag, $token, Array $data)
    {
        $pushKey = env('PUSH_NOTIFICATION_TOKEN', '');
        $fcmUrl = 'https://fcm.googleapis.com/fcm/send';
