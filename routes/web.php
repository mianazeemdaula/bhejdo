...
Route::get('/redis', function () {
    ...
    // //return $app->get('user');
    $lifters= PRedis::command('GEORADIUS',['locations' ,30.685629,73.660845, 5, 'km', ['WITHDIST','WITHCOORD', 2, 'ASC']]);
    return $lifters;
});
...
Route::get('/profile/{id}', function($id){
    ...
    return \App\Order::where('service_id',1)->where('lifter_id',$user->id)->where('status','confirmed')->pluck('id')->toArray();
    return $profile;
});
